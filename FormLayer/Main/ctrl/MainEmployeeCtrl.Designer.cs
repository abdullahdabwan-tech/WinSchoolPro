...
{
    partial class MainEmployeeCtrl
    {
        /// <summary> 
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MainEmployeeCtrl));
            panel1 = new Panel();
            btnShowList = new FontAwesome.Sharp.IconButton();
            btnFind = new FontAwesome.Sharp.IconButton();
            btnUpdate = new FontAwesome.Sharp.IconButton();
            btnAddEditEmployee = new FontAwesome.Sharp.IconButton();
            label1 = new Label();
            label2 = new Label();
            ...
            panel1.Controls.Add(btnAddEditEmployee);
            panel1.Name = "panel1";
            // 
            // btnShowList
            // 
            ...
            // btnAddEditEmployee
            // 
            resources.ApplyResources(btnAddEditEmployee, "btnAddEditEmployee");
            btnAddEditEmployee.IconChar = FontAwesome.Sharp.IconChar.UserPlus;
            btnAddEditEmployee.IconColor = Color.Black;
            btnAddEditEmployee.IconFont = FontAwesome.Sharp.IconFont.Auto;
            btnAddEditEmployee.Name = "btnAddEditEmployee";
            btnAddEditEmployee.UseVisualStyleBackColor = true;
            btnAddEditEmployee.Click += btnAddEditEmployee_Click;
            // 
            // label1
            // 
            ...
            Controls.Add(panel1);
            Controls.Add(label1);
            Name = "MainEmployeeCtrl";
            Load += MainEmployeeCtrl_Load;
        ...
        private FontAwesome.Sharp.IconButton btnAddEditEmployee;
